...
public class UserResumeDo
{
    ...
    public ICollection<WorkExperienceDo> WorkExperiences { get; set; } = new List<WorkExperienceDo>();
    public ICollection<EducationDo> Education { get; set; } = new List<EducationDo>();
    public ICollection<TrainingDo> Trainings { get; set; } = new List<TrainingDo>();
    public ICollection<JobSkillDo> Skills { get; set; } = new List<JobSkillDo>();
    public ICollection<SkillUsageDo> UncategorizedSkillUsages { get; set; } = new List<SkillUsageDo>();
...
public class WorkExperienceDo
{
    ...
    public ICollection<SkillUsageDo> Skills { get; set; } = new List<SkillUsageDo>();
...
{
    public Guid? Id { get; set; }
    public required JobSkillDo Skill { get; set; }
